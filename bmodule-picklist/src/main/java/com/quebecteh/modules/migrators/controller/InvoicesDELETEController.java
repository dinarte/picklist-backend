...
public class InvoicesDELETEController {
	...
	public void deleteAll() throws SQLException {
		...
		var logs = migrationLogRepository.findAllByFilters("bave-" + zohoOrganizationId, "zoho-inventory", "invoice", "success");
		logs.forEach( log -> {
			delete(RESOURCE, log);
		});
	}
	...
	public void deleteForCoalhoCheese() throws SQLException {
		...
		var logs = migrationLogRepository.findAllByFiltersAndSourceIds("bave-" + zohoOrganizationId, "zoho-inventory", "invoice", "success", sourceIds);
		logs.forEach( log -> {
			delete(RESOURCE, log);
		});
	}
	...
	public void delete(String resourceName, MigrationLog log) {
        ...
        String url = String.format(
            ...
            connProperties.getApiBaseUrlBooks(),
            resourceName,
