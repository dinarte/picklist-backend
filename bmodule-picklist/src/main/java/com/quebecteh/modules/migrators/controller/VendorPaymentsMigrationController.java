...
@Log4j2
@Component
public class VendorPaymentsMigrationController extends AbstractBooksMigtationDefaultColntroller {

	
	public VendorPaymentsMigrationController(ZohoConnectorProperties connProperties,
	...
	protected MigrationConfiguration getCofiguration() {
		...
		return MigrationConfiguration.builder()
			...
			.sourceEntity("purchase_order_payment")
			.sourceFieldId("id")
	...
	protected String getSql(List<String> migratedIds) {
		...
		return 
				...
				+ "join purchase_order po on po.id = pop.id_purchase_order \r\n"
				...
				+ sqlMigratedsIds
				+ "order by pop.id_purchase_order, 4 \r\n";
				//+ " LIMIT 3 OFFSET 0";
	}
	...
	protected Map<String, Object> getMappedJson(Map<String, Object> resultMap) {
		...
		String billId = getMigratedIdValue("purchaseorders", resultMap.get("id_purchase_order"), "bill");
