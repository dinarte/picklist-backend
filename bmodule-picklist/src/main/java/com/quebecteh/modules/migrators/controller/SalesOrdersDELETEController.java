...
public class SalesOrdersDELETEController {
	...
	public void deleteAll() throws SQLException {
		...
		var logs = migrationLogRepository.findAllByFilters("bave-" + zohoOrganizationId, "zoho-inventory", "salesorder", "success");
		logs.forEach( log -> {
			delete(RESOURCE, log);
		});
	}
	...
	public void deleteForCoalhoCheese() throws SQLException {
		...
		var logs = migrationLogRepository.findAllByFiltersAndSourceIds("bave-" + zohoOrganizationId, "zoho-inventory", "salesorder", "success", sourceIds);
		logs.forEach( log -> {
			delete(RESOURCE, log);
		});
	}
